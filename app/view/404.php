                ...
                <div class="row justify-content-center">
                    <div class="col-xl-7 col-lg-8">
                        <div class="text-center">
                            <img src="<?=DIR_ASSETS?>images/error400-cover.png" alt="error img" class="img-fluid">
                            <div class="mt-3">
                                <h3 class="text-uppercase">DESCULPE, ESTA PÁGINA NÃO EXISTE 😭</h3>
                                <p class="text-muted mb-4">A página que você está procurando não existe!</p>
                                <a href="index.html" class="btn btn-info"><i class="mdi mdi-home me-1"></i>Voltar Para a Página Inicial</a>
                            </div>
                        </div>
                    </div><!-- end col -->
                </div>
